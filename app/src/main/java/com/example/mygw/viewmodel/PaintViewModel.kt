...
class PaintViewModel @Inject constructor(var mainRepository: MainRepository, var context: Context): BaseViewModel(context as Application) {
    ...
    fun loadPaints(){
        setData(mainRepository.loadPaints())
    }
